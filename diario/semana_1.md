...
Un potenciómetro es clave para el contraste, sin él, la pantalla no se veía nada. El proyecto ya es autónomo, al funcionar con pila, puedo llevarlo a cualquier sitio sin depender del ordenador. Ahora cualquiera que vea mi repositorio puede entender mejor el proyecto. El siguiente paso es conectar el Arduino a Python para guardar los datos de temperatura en un archivo CSV y empezar a hacer gráficos. Eso será la Semana 2 del plan.
